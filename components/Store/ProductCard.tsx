...
const ProductCard: React.FC<IProductCardProps> = ({ product }) => {
  ...
  return (
    <figure
      key={product.id}
      className='product-card min-h-productCard max-h-productCard min-w-productCard max-w-productCard shadow-2xl flex flex-col'
    >
      <Image
        ...
        alt={product.name}
      />
      <figcaption className='product-details flex flex-col'>
